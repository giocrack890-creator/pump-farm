...
/**
 * Only `injected` — avoids `@metamask/connect-evm` (missing peer of wagmi metaMask()).
 * MetaMask / Rabby / Brave still appear via window.ethereum.
 */
const chains = [robinhoodChain, robinhoodTestnet] as const;
